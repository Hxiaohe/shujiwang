            ...
            <li class="media ys-comments-left">
                <div style="margin-right: 5px;" class="ys-comments-main">
                    <div class="media-body">
                        <h5 class="media-heading">暂无书评</h5>
                    ...
                    <div class="caption">
                        ...
                        <div class="clearfix">
                            <div class="pull-right">
                                <small>&nbsp;(本书评来自于 <a href=<%out.print("pinlun_to_book.jsp?book="+bookService.getBookByID(tempcommand.getBookId()).getLujing());%>><%out.print(bookService.getBookByID(tempcommand.getBookId()).getBookname().split("-")[0]);%>
                                </a>)
                                </small>
                            </div>
                        </div>
